...
# Make sure to create a .env file in the same directory and add your OPENAI_API_KEY
...
with st.sidebar:
    ...
    st.caption("<p style ='text-align:center'> made with  by :) RoshanLeanage</p>",unsafe_allow_html=True )
